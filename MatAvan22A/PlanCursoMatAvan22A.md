...
Esta asignación tiene por objeto calcular la velocidad (y el desplazamiento) de un extremo de una cuerda de longitud *L*, que reacciona un impulso que se le imprime en el otro extremo. Los látigos son un sistema (una cuerda inextensible) de masa variable, donde la masa por unidad de longitud en un extremo *m_0* es mucho mayor que la masa por unidad de longitud en  el otro extremo: *m_0* >> *m_L*. La descripción detallada de la asignación la podrán encontrar en [este enlace](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Asignaciones/TallerLatigosOndasdechoque/latigo.pdf)
