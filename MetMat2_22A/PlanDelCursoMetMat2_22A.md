# Plan del Curso de Métodos Matemáticos de la Física 2
...
+ **Cada tercera clase (C3C)** se hará una evaluación sustentada de los *ejercicios asignados* como tarea.  Se tomarán en cuenta diez de estas evaluaciones y sumarán el 20\%. Las solución a los ejercicios C3C se conpartirán desde el repositorio *git*
...
+ En la **clase 14 o 15** y en **la 26 o 27** se realizará una evaluación oral (o escrita según el caso) de temas cubiertos hasta esas fechas. Esta *conversación evaluada* versará sobre un cuestionario que será enviado 24 horas antes de la actividad. Estas conversaciones evaluadas acopiarán el 40% restante.
...
### Asignación 1 *Entre rayos, señales y Ruido* (Entrega hasta clase 4 y discusión clase 5)
...
+ [ Clase 5 Taller y ajuste 1]

+ [ Clase 6 Evaluación y ajuste 2]

### Asignación 2  (Entrega hasta clase 9 y discusión clase 10/11)
...
+ [Clase 15 Soluciones numéricas al problema de valores iniciales en ecuaciones diferenciales ordinarias](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Clases/EnConstruccion.md)

+ [Clase 16 Sistemas dinámicos](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Clases/EnConstruccion.md)

+ [Clase 17 Problema de Sturm Liuville y los valores de frontera](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Clases/EnConstruccion.md)
...
+ [ Clase 21 Evaluación y ajuste 2]


### Asignación 4  (Entrega hasta clase 9 y discusión clase 10/11)

### Ecuaciones en derivadas parciales
<a name="DiferencialesParciales"></a>
+ [Clase 21 Ecuaciones diferenciales parciales: generalidades](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Clases/EnConstruccion.md)

+ [Clase 22 Ecuaciones diferenciales parciales: la ecuación de onda ](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Clases/EnConstruccion.md)

+ [Clase 23 Ecuaciones diferenciales parciales: la ecuación de Calor ](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Clases/EnConstruccion.md)

+ [Clase 24 Ecuaciones diferenciales parciales: la ecuación de Laplace ](https://github.com/nunezluis/MisCursos/blob/main/MisMateriales/Clases/EnConstruccion.md)
