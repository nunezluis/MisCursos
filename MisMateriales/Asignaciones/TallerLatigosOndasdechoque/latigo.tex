...
\begin{enumerate}
    ...
    \item Para finalizar, considere el problema de masa variable y calcule la velocidad del extremo mas delgado. Este problema lo debe considerar tanto desde el punto de vista analítico como numérico, resolviéndolo mediante diferencias finitas.
