...
\begin{itemize}  
	\item<1-> El Lagrangeano será $L =\dot{q} p-H$. De la ecuación de movimiento 
	$\dot{q}=\frac{\partial H}{\partial p}=\frac{p}{m}-\frac{A}{m} \cos \gamma t, \quad \Rightarrow \quad p=m \dot{q}+A \cos \gamma t$
\end{itemize}
}
