...
\begin{itemize}
	\item<1-> Por su parte, respecto al sistema centro de masa, $\tilde{S}$ tenemos $\vec{r}(cp) = -a {\bf x}^2$, y $\vec{\Omega} \times \vec{r}(cp) = 
	\left|
	\begin{array}{ccc} 
	{\bf x}^1 & {\bf x}^2 & {\bf x}^3 \\
	\tilde{\Omega}^1 & \tilde{\Omega}^2 & \Omega^3 \\
	0 & -a & 0
	\end{array}\right| = a(\Omega^3 \, {\bf x}_1 -\Omega^1\, {\bf x}_3) $
